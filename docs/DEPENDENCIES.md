...
| yt-dlp | nightly 2026.08.18.122307 | `https://github.com/yt-dlp/yt-dlp-nightly-builds/releases/download/2026.08.18.122307/yt-dlp` | `.cache/dependencies/downloader` and `build/downloader` | Pinned SHA-256 plus archive-content validation; temporarily packaged as the shipped baseline because stable 2026.07.04's Android-VR media URLs began failing with HTTP 403. |
